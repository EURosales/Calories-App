...
function modeChecker() {
    ...
    if (activeDarkMode == true) {
        ...
        //Cereal seleccionado
        cereal.classList.add('selected-light');
        cereal.classList.remove('selected-dark');
        //Cereal seleccionado
        eggs.classList.add('selected-light');
        eggs.classList.remove('selected-dark');
        //Cereal seleccionado
...
function selectChecker(object) {
    if (object.name.classList.contains('unselected')) {
        object.name.classList.add('selected');
        object.name.classList.remove('unselected');
    } else {
        object.name.classList.remove('selected');
        object.name.classList.add('unselected');
    }
}

// function selectChecker(object) {
//     if (object.name.classList.contains('unselected') && activeDarkMode == true) {
//         object.name.classList.add('selected-dark');
//         //object.name.classList.add('selected');
//         object.name.classList.remove('unselected');
//     } else if (object.name.classList.contains('unselected') && activeDarkMode == false) {
//         object.name.classList.remove('unselected');
//         object.name.classList.add('selected-light');
//         //object.name.classList.add('selected');
//     } else if (object.name.classList.contains('selected-light') && activeDarkMode == true) {
//         object.name.classList.remove('selected-light');
//         object.name.classList.add('selected-dark');
//         //object.name.classList.add('selected');
//     } else if (object.name.classList.contains('selected-dark') && activeDarkMode == false) {
//         object.name.classList.add('unselected');
//         object.name.classList.remove('selected-dark');
//     } else if (object.name.classList.contains('selected-light') && activeDarkMode == false) {
//         object.name.classList.add('unselected');
//         object.name.classList.remove('selected-light');
//     } else if (object.name.classList.contains('selected-dark') && activeDarkMode == true) {
//         object.name.classList.add('unselected');
//         object.name.classList.remove('selected-dark');
//     }
// }
